...
def get_load_path(root, load_run=-1, checkpoint=-1):
    try:
        ...
        # Sort by modification time (newest last), filtering out non-directories like 'exported' if needed
        runs = [r for r in runs if os.path.isdir(os.path.join(root, r)) and r != 'exported']
